...
<div class="form-group {{ $errors->has('cautionnement') ? 'has-error' : '' }}">
 ...
 <label class="switch"><input  type="checkbox" id="cautionnement" name="cautionnement" {{  old('cautionnement', optional($produit)->cautionnement ?: 'off') ? 'checked' : '' }}>
    <div class="slider round"><!--ADDED HTML -->
        <span class="on">{{trans('produits.Yes') }}</span><span class="off">{{trans('produits.NO') }}</span><!--END--></div></label>
...
<div class="form-group {{ $errors->has('salon') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input required class="form-control" name="salon" type="number" id="salon" value="{{ old('salon', optional($produit)->salon) }}" minlength="1" placeholder="{{ trans('produits.salon__placeholder') }}">
...
<div class="form-group {{ $errors->has('toilet') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input required class="form-control" name="toilet" type="number" id="toilet" value="{{ old('toilet', optional($produit)->toilet) }}" minlength="1" placeholder="{{ trans('produits.toilet__placeholder') }}">
...
<div class="form-group {{ $errors->has('room') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input required class="form-control" name="room" type="number" id="room" value="{{ old('room', optional($produit)->room) }}" minlength="1" placeholder="{{ trans('produits.room__placeholder') }}">
...
<div class="form-group {{ $errors->has('wifi') ? 'has-error' : '' }}">
 ...
 <label class="switch">
    ...
    <input  type="checkbox" id="wifi" name="wifi" {{  old('wifi', optional($produit)->wifi ?: 'off') ? 'checked' : '' }}><div class="slider round"><!--ADDED HTML --><span class="on">{{trans('produits.Yes') }}</span><span class="off">{{trans('produits.NO') }}</span><!--END--></div></label>
...
<div class="form-group {{ $errors->has('furnished') ? 'has-error' : '' }}">
 ...
 <label class="switch">
    <input  type="checkbox" id="furnished" name="furnished" {{  old('furnished', optional($produit)->furnished ?: 'off') ? 'checked' : '' }}>
    <div class="slider round"><!--ADDED HTML -->
