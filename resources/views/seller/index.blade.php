    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-right">
                <h4 class="mt-5 mb-5"> {{ trans('general.seller') }}</h4>
            </div>

            <div class="btn-group btn-group-sm pull-left" role="group">
                <a href="{{ route('seller.seller.create') }}" class="btn btn-success" title="Create New User">
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                         <a href="{{ url('history', $user->id ) }}" class="btn btn-success" title="{{ trans('vips.vip') }}">
                                          <i class="fa fa-history fa-2" aria-hidden="true"></i>

                                        </a>

                                        <a href="{{ route('seller.seller.show', $user->id ) }}" class="btn btn-info" title="Show User">
