...
<div class="form-group {{ $errors->has('discription') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input required class="form-control" name="discription" type="text" id="discription" value="{{ old('discription', optional($produit)->discription) }}" minlength="1" placeholder="{{ trans('produits.discription__placeholder') }}">
...
<div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
       <input required class="form-control" name="price" type="number" id="price" value="{{ old('price', optional($produit)->price) }}" minlength="1"  min="100"placeholder="{{ trans('produits.price__placeholder') }}">
...
<div class="form-group {{ $errors->has('ville_id') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <select required class="form-control" id="ville_id" name="ville_id">
...
<div class="form-group {{ $errors->has('rent_sale') ? 'has-error' : '' }}">
 ...
 <label class="switch">
    <input  type="checkbox" id="rent_sale" name="rent_sale" {{  old('rent_sale', optional($produit)->rent_sale ?: 'off') ? 'checked' : '' }}>
    <div class="slider round"><!--ADDED HTML -->
        <span class="on">{{trans('produits.rent') }}</span><span class="off">{{trans('produits.sale') }}</span><!--END-->
    </div>
</label>
...
<div class="form-group {{ $errors->has('chiket') ? 'has-error' : '' }}">
 ...
 <label class="switch"><input type="checkbox" id="chiket" name="chiket" {{  old('chiket', optional($produit)->chiket ?: 'off') ? 'checked' : '' }}><div class="slider round"><!--ADDED HTML --><span class="on">Yes</span><span class="off">{{trans('produits.NO') }}</span><!--END--></div></label>
...
<div class="form-group {{ $errors->has('cautionnement') ? 'has-error' : '' }}">
 ...
 <label class="switch"><input type="checkbox" id="cautionnement" name="cautionnement" {{  old('cautionnement', optional($produit)->cautionnement ?: 'off') ? 'checked' : '' }}><div class="slider round"><!--ADDED HTML --><span class="on">Yes</span><span class="off">{{trans('produits.NO') }}</span><!--END--></div></label>
...
<div   id="price_cautionnement_div"  class="form-group {{ $errors->has('price_cautionnement') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input required class="form-control" name="price_cautionnement" type="number" id="price_cautionnement" value="{{ old('price_cautionnement', optional($produit)->price_cautionnement) }}" minlength="1" placeholder="{{ trans('produits.price_cautionnement__placeholder') }}">
...
<div class="form-group {{ $errors->has('espacer') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input required class="form-control" name="espacer" type="number" id="espacer" value="{{ old('espacer', optional($produit)->espacer) }}" minlength="1" placeholder="{{ trans('produits.espacer__placeholder') }}">
...
<div class="form-group {{ $errors->has('route_principale') ? 'has-error' : '' }}">
 ...
 <label class="switch"><input type="checkbox" id="route_principale" name="route_principale" {{  old('route_principale', optional($produit)->route_principale ?: 'off') ? 'checked' : '' }}><div class="slider round"><!--ADDED HTML --><span class="on">Yes</span><span class="off">{{trans('produits.NO') }}</span><!--END--></div></label>
