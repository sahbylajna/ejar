...
@section('content')
  ...
  <form method="POST" action="{{ route('users.user.store') }}" id="edit_user_form" name="edit_user_form" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal">
      {{ csrf_field() }}
   <div class="col-md-12">
