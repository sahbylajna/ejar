...
@section('content')
  ...
  <form method="POST" action="{{ route('seller.seller.store') }}" id="edit_user_form" name="edit_user_form" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal">
      {{ csrf_field() }}
   <div class="col-md-12">
        ...
        <div class="input-group uploaded-file-group">
            <label class="input-group-btn">
                ...
                <span class="btn btn-default" style="background: transparent; border: transparent;">
                     <img id="blah" src="https://upload.wikimedia.org/wikipedia/commons/5/50/User_icon-cp.svg" alt=" " style="height:260px;width:260px;border-radius: 50%;border-style: solid;border-width:2px;border-color:#3C8DBC;" />
...
<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="name" type="text" style="direction: ltr; text-align: end;" id="name" value="" minlength="1" maxlength="255" placeholder="{{ trans('produits.name__placeholder') }}">
...
<div class="form-group {{ $errors->has('user_name') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="user_name" type="text" style="direction: ltr; text-align: end;" id="user_name" value="" minlength="1" placeholder="">
...
<div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
       <input class="form-control" name="email" type="email" style="direction: ltr; text-align: end;" id="email" value="" minlength="1"  min="100">
            ...
            <div id="mape" style="    height: 300px;width: 400; "></div>
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-sm-12">
                  ...
                  <input type="text" style="direction: ltr; text-align: end;" class=" col-sm-10 form-control" value="" id="latitude" placeholder="latitude " name="latitude" readonly required>
                </div>
                </div>
                <div class="form-group col-sm-12">
                  <label for="longitude" class="col-sm-2 control-label">{{trans('produits.Longitude') }}</label>
                   <div class="form-group col-sm-10">
                  <input type="text" style="direction: ltr; text-align: end;" class="col-sm-10 form-control" value="" id="longitude" placeholder="longitude " name="longitude" readonly required>
                </div>
            </div>

<div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
    <label for="phone" class="col-md-2 control-label">{{ trans('countries.Countries') }}</label>
    <div class="col-md-10">
            <select class="form-control " name="countries" id="countries">
              <option>{{ trans('countries.choix')}}</option>
...
<div class="form-group {{ $errors->has('instagrame') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="instagram" type="text" style="direction: ltr; text-align: end;" id="instagrame" value="" minlength="1" placeholder="{{ trans('produits.instagrame__placeholder') }}">
...
<div class="form-group {{ $errors->has('facebook') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="facebook" type="text" style="direction: ltr; text-align: end;" id="facebook" value="" minlength="1" placeholder="{{ trans('produits.facebook__placeholder') }}">
...
<div class="form-group {{ $errors->has('siteweb') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="siteweb" type="text" style="direction: ltr; text-align: end;" id="siteweb" value="" minlength="1" placeholder="{{ trans('produits.siteweb__placeholder') }}">
...
<div class="form-group {{ $errors->has('whatsapp') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="whats" type="text" style="direction: ltr; text-align: end;" id="whatsapp" value="" minlength="1" placeholder="{{ trans('produits.whatsapp__placeholder') }}">
