...
<form method="POST" action="{{ route('users.user.update', $user->id) }}" id="edit_user_form" name="edit_user_form" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal">
      {{ csrf_field() }}
   <div class="col-md-12">
...
<div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
       <input class="form-control col-md-6" name="phone" type="tel" style="direction: ltr; text-align: end;" id="phone" value="{{ $user->phone}}" minlength="1" maxlength="8" placeholder="12 -345-678">
            <select class="form-control col-md-2" name="phone_code" style="    margin-right: 15px;">

                @foreach($countries as $key => $value)
                <option value="+{{$value->phonecode}}" {{ old('phonecode', optional($user)->phone_code) == +$value->phonecode ? 'selected' : '' }}>{{$value->phonecode}}+</option>
                @endforeach
            </select>
    </div>
</div>
...
<div class="form-group {{ $errors->has('instagrame') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="instagram" type="text" style="direction: ltr; text-align: end;" id="instagrame" value="{{ $user->instagram}}" minlength="1" placeholder="{{ trans('produits.instagrame__placeholder') }}">
...
<div class="form-group {{ $errors->has('facebook') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="facebook" type="text" style="direction: ltr; text-align: end;" id="facebook" value="{{ $user->facebook}}" minlength="1" placeholder="{{ trans('produits.facebook__placeholder') }}">
...
<div class="form-group {{ $errors->has('siteweb') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="siteweb" type="text" style="direction: ltr; text-align: end;" id="siteweb" value="{{ $user->siteweb}}" minlength="1" placeholder="{{ trans('produits.siteweb__placeholder') }}">
...
<div class="form-group {{ $errors->has('whatsapp') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="whats" type="text" style="direction: ltr; text-align: end;" id="whatsapp" value="{{$user->phone_code}}{{ $user->whats}}" minlength="1" placeholder="{{ trans('produits.whatsapp__placeholder') }}">
