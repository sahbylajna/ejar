        ...
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <div class="wrap">
                        ...
                        <div class="box " style="background: url('https://cdn.icon-icons.com/icons2/2596/PNG/512/ad_product_icon_155850.png');background-repeat: no-repeat;
    background-size: cover;
    background-position: center;">
        <div class="date">
            <h4>{{ trans('general.Produit') }} </h4>
        </div>
        <h1><a href="{{ url('historyproduit',$id) }}" style="color: #fff;">{{ trans('general.Produit') }}</a></h1>
                        ...
                        <div class="box " style="background: url('https://www.svgrepo.com/show/282451/real-estate-rent.svg');background-repeat: no-repeat;
    background-size: cover;
    background-position: center;">
        <div class="date">
            <h4>{{ trans('order_rents.model_plural') }} </h4>
        </div>
        <h1><a href="{{ url('OrderRents',$id) }}" style="color: #fff;">{{ trans('order_rents.model_plural') }}</a></h1>
        ...
        <div class="box " style="background: url('https://image.flaticon.com/icons/png/128/2897/2897973.png');background-repeat: no-repeat;
    background-size: cover;
    background-position: center;">
        <div class="date">
            <h4>{{ trans('order_seles.model_plural') }} </h4>
        </div>
        <h1><a href="{{  url('OrderSeles',$id) }}" style="color: #fff;">{{ trans('order_seles.model_plural') }}</a></h1>
...
<!-- ///// -->
     ...
     <div class="box " style="background: url('https://cdn-icons-png.flaticon.com/512/637/637088.png');background-repeat: no-repeat;
    background-size: cover;
    background-position: center;">
        <div class="date">
            <h4>{{ trans('general.vip1') }} </h4>
        </div>
        <h1><a href="{{  url('historyvip1',$id) }}" style="color: #fff;">{{ trans('general.vip1') }}</a></h1>
     ...
     <div class="box " style="background: url('https://cdn-icons-png.flaticon.com/512/637/637088.png');background-repeat: no-repeat;    background-size: cover;    background-position: center;">
        <div class="date">
            <h4>{{ trans('general.vip2') }} </h4>
        </div>
        <h1><a href="{{  url('historyvip2',$id) }}" style="color: #fff;">{{ trans('general.vip2') }}</a></h1>
