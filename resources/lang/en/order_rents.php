...
return [
    ...
    'Produit' => 'Produit',
    'Produit__placeholder' => 'Enter produit here...',
    'User' => 'User',
    'User__placeholder' => 'Enter user here...',
    'price' => 'Price',
    'price__placeholder' => 'Enter price here...',
    'datestart' => 'Datestart',
    'datestart__placeholder' => 'Enter datestart here...',
    'dateend' => 'Dateend',
    'dateend__placeholder' => 'Enter dateend here...',
    ...
    'index_route_description' => 'Retrieve existing order rents.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the order rent property name where the value is the assigned value to the retrieved order rent.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved order rent.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of order rents per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved order rent.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new order rent.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing order rent.',
    ...
    'show_route_description' => 'Retrieve existsing order rent.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the order rent to retrieve',
    'destroy_route_description' => 'Delete existsing order rent.',
    ...
    'the_id_of_model_to_delete' => 'The id of the order rent to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete order rents.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the order rent.',
    ...
    'the_requested_model_does_not_exists' => 'The requested order rent does not exists.',
    ...
    'create' => 'Create New Order Rent',
    'delete' => 'Delete Order Rent',
    'edit' => 'Edit Order Rent',
    'show' => 'Show Order Rent',
    'show_all' => 'Show All Order Rent',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Order Rent.',
    'none_available' => 'No Order Rents Available.',
    'model_plural' => 'Order Rents',
    'model_was_added' => 'Order Rent was successfully added.',
    'model_was_retrieved' => 'Order Rent was successfully retrieved.',
    'models_were_retrieved' => 'Order Rents were successfully retrieved.',
    'model_was_updated' => 'Order Rent was successfully updated.',
    'model_was_deleted' => 'Order Rent was successfully deleted.',
    ...
    'model_id_camel_case' => 'order rentId',
