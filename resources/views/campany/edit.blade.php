...
<div class="form-group {{ $errors->has('CommercialRecord') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
       <input class="form-control" name="CommercialRecord" type="text" style="direction: ltr; text-align: end;" id="CommercialRecord"  minlength="1"  min="100" value="{{ old('CommercialRecord', optional($user)->CommercialRecord) }}" >
        {!! $errors->first('CommercialRecord', '<p class="help-block">:message</p>') !!}
    </div>
</div>
...
<div class="form-group {{ $errors->has('whatsapp') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="whats" type="text" style="direction: ltr; text-align: end;" id="whatsapp" value="{{ $user->whats}}" minlength="1" placeholder="{{ trans('produits.whatsapp__placeholder') }}">
