...
<div class="form-group {{ $errors->has('espacer') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input  required class="form-control" name="espacer" type="text" id="espacer" value="{{ old('espacer', optional($produit)->espacer) }}" minlength="1" placeholder="{{ trans('produits.espacer__placeholder') }}">
...
<div class="form-group {{ $errors->has('firstsaken') ? 'has-error' : '' }}">
 ...
 <label class="switch">
    ...
    <input   type="checkbox" id="firstsaken" name="firstsaken" {{  old('firstsaken', optional($produit)->firstsaken ?: 'off') ? 'checked' : '' }}><div class="slider round"><!--ADDED HTML --><span class="on">{{trans('produits.Yes') }}</span><span class="off">{{trans('produits.NO') }}</span><!--END--></div></label>
