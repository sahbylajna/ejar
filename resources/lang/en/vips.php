...
return [
    ...
    'vip' => 'Vip',
    'vip__placeholder' => 'Enter vip here...',
    'date' => 'Date Start',
    'dateend' => 'date End',
    ...
    'index_route_description' => 'Retrieve existing vips.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the vip property name where the value is the assigned value to the retrieved vip.',
    ...
    'show_route_description' => 'Retrieve existsing vip.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the vip to retrieve',
    'destroy_route_description' => 'Delete existsing vip.',
    ...
    'the_id_of_model_to_delete' => 'The id of the vip to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete vips.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the vip.',
    ...
    'the_requested_model_does_not_exists' => 'The requested vip does not exists.',
    ...
    'create' => 'Create New Vip',
    'delete' => 'Delete Vip',
    'edit' => 'Edit Vip',
    'show' => 'Show Vip',
    'show_all' => 'Show All Vip',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Vip.',
    'none_available' => 'No Vips Available.',
    'model_plural' => 'Vips',
    'model_was_added' => 'Vip was successfully added.',
    'model_was_retrieved' => 'Vip was successfully retrieved.',
    'models_were_retrieved' => 'Vips were successfully retrieved.',
    'model_was_updated' => 'Vip was successfully updated.',
    'model_was_deleted' => 'Vip was successfully deleted.',
