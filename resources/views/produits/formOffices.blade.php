...
<div class="form-group {{ $errors->has('officeoy') ? 'has-error' : '' }}">
 ...
 <label class="switch"><input  type="checkbox" id="officeoy" name="officeoy" {{  old('officeoy', optional($produit)->officeoy ?: 'off') ? 'checked' : '' }}><div class="slider round"><!--ADDED HTML --><span class="on">{{trans('produits.Yes') }}</span><span class="off">{{trans('produits.NO') }}</span><!--END--></div></label>
...
<div class="form-group {{ $errors->has('office') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input  class="form-control" name="office" type="number" id="office" value="{{ old('office', optional($produit)->office) }}" minlength="1" placeholder="{{ trans('produits.office__placeholder') }}">
...
<div class="form-group {{ $errors->has('secretary') ? 'has-error' : '' }}">
 ...
 <label class="switch"><input  type="checkbox" id="secretary" name="secretary" {{  old('secretary', optional($produit)->secretary ?: 'off') ? 'checked' : '' }}><div class="slider round"><!--ADDED HTML --><span class="on">{{trans('produits.Yes') }}</span><span class="off">{{trans('produits.NO') }}</span><!--END--></div></label>
...
<div class="form-group {{ $errors->has('imprimerie') ? 'has-error' : '' }}">
 ...
 <label class="switch"><input  type="checkbox" id="imprimerie" name="imprimerie" {{  old('imprimerie', optional($produit)->imprimerie ?: 'off') ? 'checked' : '' }}><div class="slider round"><!--ADDED HTML --><span class="on">{{trans('produits.Yes') }}</span><span class="off">{{trans('produits.NO') }}</span><!--END--></div></label>
