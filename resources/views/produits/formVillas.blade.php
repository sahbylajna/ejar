...
<div class="form-group {{ $errors->has('salon') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="salon" type="number" id="salon" value="{{ old('salon', optional($produit)->salon) }}" minlength="1" placeholder="{{ trans('produits.salon__placeholder') }}">
...
<div class="form-group {{ $errors->has('toilet') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="toilet" type="number" id="toilet" value="{{ old('toilet', optional($produit)->toilet) }}" minlength="1" placeholder="{{ trans('produits.toilet__placeholder') }}">
...
<div class="form-group {{ $errors->has('room') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="room" type="number" id="room" value="{{ old('room', optional($produit)->room) }}" minlength="1" placeholder="{{ trans('produits.room__placeholder') }}">
