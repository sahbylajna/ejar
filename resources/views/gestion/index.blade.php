...
<div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5"> {{ trans('general.gestion' )}}</h4>
            </div>
    ...
    background-position: center;">
        ...
        <h1><a href="{{ route('order_rents.order_rent.index') }}" style="color: #fff;">{{ trans('order_rents.model_plural') }}</a></h1>
    ...
    background-position: center;">
        ...
        <h1><a href="{{ route('order_seles.order_sele.index') }}" style="color: #fff;">{{ trans('order_seles.model_plural') }}</a></h1>
