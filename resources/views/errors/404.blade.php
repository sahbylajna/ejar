...
<body>
  ...
  <div class="bg-img1 size1 overlay1 p-b-35 p-l-15 p-r-15" style="background-image: url('images/bg01.jpg');">
    ...
    <div class="flex-w flex-c-m p-b-35">
      <a href="https://www.facebook.com/ejar.qa" class="size3 flex-c-m how-social trans-04 m-r-3 m-l-3 m-b-5">
        <i class="fa fa-facebook"></i>
      </a>

      <a href="https://www.instagram.com/ejar.qa/?hl=fr" class="size3 flex-c-m how-social trans-04 m-r-3 m-l-3 m-b-5">
        <i class="fa fa-instagram"></i>
      </a>

      <a href="#" class="size3 flex-c-m how-social trans-04 m-r-3 m-l-3 m-b-5">
        <i class="fa fa-phone"></i>
      </a><p class="size3 flex-c-m how-social trans-04 m-r-3 m-l-3 m-b-5" style="border: transparent;
    justify-content: left;background-color: transparent;
    color: #ffff;" >5555555</p>
    </div>
  </div>
