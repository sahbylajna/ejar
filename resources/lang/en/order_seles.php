...
return [
    ...
    'index_route_description' => 'Retrieve existing order seles.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the order sele property name where the value is the assigned value to the retrieved order sele.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved order sele.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of order seles per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved order sele.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new order sele.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing order sele.',
    ...
    'show_route_description' => 'Retrieve existsing order sele.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the order sele to retrieve',
    'destroy_route_description' => 'Delete existsing order sele.',
    ...
    'the_id_of_model_to_delete' => 'The id of the order sele to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete order seles.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the order sele.',
    ...
    'the_requested_model_does_not_exists' => 'The requested order sele does not exists.',
    ...
    'create' => 'Create New Order Sele',
    'delete' => 'Delete Order Sele',
    'edit' => 'Edit Order Sele',
    'show' => 'Show Order Sele',
    'show_all' => 'Show All Order Sele',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Order Sele.',
    'none_available' => 'No Order Seles Available.',
    'model_plural' => 'Order Seles',
    'model_was_added' => 'Order Sele was successfully added.',
    'model_was_retrieved' => 'Order Sele was successfully retrieved.',
    'models_were_retrieved' => 'Order Seles were successfully retrieved.',
    'model_was_updated' => 'Order Sele was successfully updated.',
    'model_was_deleted' => 'Order Sele was successfully deleted.',
    ...
    'model_id_camel_case' => 'order seleId',
