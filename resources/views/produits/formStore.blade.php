...
<div class="form-group {{ $errors->has('On_a_paved_road') ? 'has-error' : '' }}">
    <label for="On_a_paved_road" class="col-md-2 control-label">{{ trans('produits.On_a_paved_road') }}</label>
    <div class="col-md-10">


 <label class="switch"><input type="checkbox" id="On_a_paved_road" name="On_a_paved_road" {{  old('On_a_paved_road', optional($produit)->On_a_paved_road ?: 'off') ? 'checked' : '' }}><div class="slider round"><!--ADDED HTML --><span class="on">{{trans('produits.Yes') }}</span><span class="off">{{trans('produits.NO') }}</span><!--END--></div></label>


        {!! $errors->first('On_a_paved_road', '<p class="help-block">:message</p>') !!}
    </div>
</div>
...
<div class="form-group {{ $errors->has('Height') ? 'has-error' : '' }}">
    <label for="Height" class="col-md-2 control-label">{{ trans('produits.Height') }}</label>
    <div class="col-md-10">
        <input class="form-control" name="Height" type="number" id="Height" value="{{ old('Height', optional($produit)->Height) }}" minlength="1" placeholder="{{ trans('produits.Height__placeholder') }}">
...
<div class="form-group {{ $errors->has('Number_of_doors') ? 'has-error' : '' }}">
    <label for="Number_of_doors" class="col-md-2 control-label">{{ trans('produits.Number_of_doors') }}</label>
    <div class="col-md-10">
        <input class="form-control" name="Number_of_doors" type="number" id="Number_of_doors" value="{{ old('Number_of_doors', optional($produit)->Number_of_doors) }}" minlength="1" placeholder="{{ trans('produits.Number_of_doors__placeholder') }}">
        {!! $errors->first('Number_of_doors', '<p class="help-block">:message</p>') !!}
    </div>
</div>
