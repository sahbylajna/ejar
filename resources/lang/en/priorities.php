...
return [
    ...
    'date_start__placeholder' => 'Enter date start here...',
    'date_end' => 'Date End',
    'date_end__placeholder' => 'Enter date end here...',
    'user_id' => 'Company',
    'user_id__placeholder' => 'Select Company',
    'numbre' => 'The number of properties allowed',
    'numbre__placeholder' => 'Enter numbre here...',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing priorities.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the priority property name where the value is the assigned value to the retrieved priority.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved priority.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of priorities per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved priority.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new priority.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing priority.',
    ...
    'show_route_description' => 'Retrieve existsing priority.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the priority to retrieve',
    'destroy_route_description' => 'Delete existsing priority.',
    ...
    'the_id_of_model_to_delete' => 'The id of the priority to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete priorities.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the priority.',
    ...
    'the_requested_model_does_not_exists' => 'The requested priority does not exists.',
    ...
    'create' => 'Create New Priority',
    'delete' => 'Delete Priority',
    'edit' => 'Edit Priority',
    'show' => 'Show Priority',
    'show_all' => 'Show All Priority',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Priority.',
    'none_available' => 'No Priorities Available.',
    'model_plural' => 'Priorities',
    'model_was_added' => 'Priority was successfully added.',
    'model_was_retrieved' => 'Priority was successfully retrieved.',
    'models_were_retrieved' => 'Priorities were successfully retrieved.',
    'model_was_updated' => 'Priority was successfully updated.',
    'model_was_deleted' => 'Priority was successfully deleted.',
    ...
    'model_id_camel_case' => 'priorityId',
